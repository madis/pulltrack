...
RSpec.describe PullRequestsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested pull_request as @pull_request" do
      pull_request = PullRequest.create! valid_attributes
      get :show, params: {id: pull_request.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested pull_request as @pull_request" do
      pull_request = PullRequest.create! valid_attributes
      get :edit, params: {id: pull_request.to_param}, session: valid_session
      expect(assigns(:pull_request)).to eq(pull_request)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new PullRequest" do
        expect {
          post :create, params: {pull_request: valid_attributes}, session: valid_session
      ...
      it "redirects to the created pull_request" do
        post :create, params: {pull_request: valid_attributes}, session: valid_session
        expect(response).to redirect_to(PullRequest.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved pull_request as @pull_request" do
        post :create, params: {pull_request: invalid_attributes}, session: valid_session
        expect(assigns(:pull_request)).to be_a_new(PullRequest)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested pull_request" do
        pull_request = PullRequest.create! valid_attributes
        put :update, params: {id: pull_request.to_param, pull_request: new_attributes}, session: valid_session
        pull_request.reload
      ...
      it "assigns the requested pull_request as @pull_request" do
        pull_request = PullRequest.create! valid_attributes
        put :update, params: {id: pull_request.to_param, pull_request: valid_attributes}, session: valid_session
        expect(assigns(:pull_request)).to eq(pull_request)
      end
      ...
      it "redirects to the pull_request" do
        pull_request = PullRequest.create! valid_attributes
        put :update, params: {id: pull_request.to_param, pull_request: valid_attributes}, session: valid_session
        expect(response).to redirect_to(pull_request)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the pull_request as @pull_request" do
        pull_request = PullRequest.create! valid_attributes
        put :update, params: {id: pull_request.to_param, pull_request: invalid_attributes}, session: valid_session
        expect(assigns(:pull_request)).to eq(pull_request)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested pull_request" do
      pull_request = PullRequest.create! valid_attributes
      expect {
        delete :destroy, params: {id: pull_request.to_param}, session: valid_session
      }.to change(PullRequest, :count).by(-1)
    end
    ...
    it "redirects to the pull_requests list" do
      pull_request = PullRequest.create! valid_attributes
      delete :destroy, params: {id: pull_request.to_param}, session: valid_session
      expect(response).to redirect_to(pull_requests_url)
    end
  end
